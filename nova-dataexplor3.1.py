...
# Yelp Llm  prediction part
    def run_llm_prediction(self):
        ...
        try:
            ...
            test_df['predicted_sentiment'] = predictions#csv  olarak kaydetmek için eklendi
        ...
        self.save_button.configure(state="normal", fg_color="#1f6aa5")#csv olarak kaydetmek için eklendi
  #Ag news Llm prediction part
    def run_ag_news_prediction(self):
        ...
        try:
            ...
            train_df = pd.read_csv(labeled_file)
            text_col = 'description' if 'description' in train_df.columns else 'text'
