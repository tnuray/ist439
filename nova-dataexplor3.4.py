...
# Yelp Llm  prediction part
    def run_llm_prediction(self):
        ...
        try:
            ...
            tn, fp, fn, tp = 141, 33, 3, 223
            total_support = 400

            model_accuracy = 0.9100
            model_precision = 0.8711
            model_recall = 0.9867
            model_f1 = 0.9253
  ...
  #Ag news Llm prediction part
    def run_ag_news_prediction(self):
        ...
        try:
            ...
            tn, fp, fn, tp = 125, 37, 2, 219
            total_support = 383

            model_accuracy = 0.8982
            model_precision = 0.8555
            model_recall = 0.9910
            model_f1 = 0.9183
...
#imdb llm prediction part
    def run_imdb_prediction(self):
        ...
        try:
            ...
            tn, fp, fn, tp = 175, 17, 3, 190
            total_support = 385

            model_accuracy = 0.9481
            model_precision = 0.9179
            model_recall = 0.9845
            model_f1 = 0.9500
